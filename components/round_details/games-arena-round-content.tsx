...
import { GamesArenaCandidatesTable } from "./games-arena-candidates-table"
    ...
    try {
      for (let i = 0; i < candidatesWithoutEvaluation.length; i++) {
        ...
        try {
          ...
          await evaluateSalesCandidate(request, 'GAMES_ARENA')
    ...
    <div className="flex-1 flex flex-col bg-white">
      ...
      >
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Sales Assessment Settings - {currentRound?.round_name || 'Games Arena Round'}</DialogTitle>
            <DialogDescription>
