...
interface ModernProjectCandidatesTableProps {
...
export function ModernProjectCandidatesTable({
  candidates,
  ...
  onCandidateUpdated = () => {},
  sparrowRoundId = '',
  currentRoundName = 'Project Round',
  candidateReEvaluationStates = {},
  onReEvaluationStateChange = () => {}
}: ModernProjectCandidatesTableProps) {
    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center">
        ...
        <p className="text-gray-500" style={{ fontFamily }}>
          No candidates have been added to this project round yet.
        </p>
      </div>
    )
  }
