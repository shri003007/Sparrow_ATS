...
interface ModernTalkOnTopicCandidatesTableProps {
...
export function ModernTalkOnTopicCandidatesTable({
  candidates,
...
}: ModernTalkOnTopicCandidatesTableProps) {
    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center">
        ...
        <p className="text-gray-500" style={{ fontFamily }}>
          No candidates have been added to this talk on topic round yet.
        </p>
      </div>
    )
  }
    ...
    <>
      ...
      {selectedCandidate && isPanelOpen && (
        <CandidateEvaluationPanel
          ...
          roundType={roundInfo?.round_type || 'TALK_ON_TOPIC'}
